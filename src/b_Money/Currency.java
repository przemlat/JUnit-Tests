...
public class Currency {
	...
	public Integer universalValue(Integer amount) {
		...
		int uniAmount = (int)(amount*this.getRate());
		return uniAmount;
	...
	*/
	public Integer valueInThisCurrency(Integer amount, Currency othercurrency) {
		...
		int uniValue = othercurrency.universalValue(amount);
		int valueInThisCurr = (int)(uniValue/this.getRate());
		
		return valueInThisCurr;
