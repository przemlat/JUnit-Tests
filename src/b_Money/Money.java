...
public class Money implements Comparable {
	...
	public String toString() {
		double amountDouble = this.getAmount()/100;
		String amountString = amountDouble + " " + this.getCurrency().getName();
		return amountString;
	}
	...
	public Integer universalValue() {
		return (int)(this.getCurrency().universalValue(this.getAmount()));
	}
	...
	public Money add(Money other) {
		...
		int addedMoney = this.universalValue() + other.universalValue();
		this.amount = (int)(addedMoney/this.getCurrency().getRate());
	...
	public Money sub(Money other) {
		...
		int subMoney = this.universalValue() - other.universalValue();
		this.amount = (int)(subMoney/this.getCurrency().getRate());
	...
	public Money negate() {
		...
		this.amount = this.getAmount() - 2*this.getAmount();
	...
	public int compareTo(Object other) {
		...
		int res = this.universalValue().compareTo(otherMoney.universalValue());
